...
#define MODULE_CODE "DeskElectricalOutlets"
#define MODULE_NAME "Zappy2"
#define MODULE_DEVICE_NAME "Prese Scrivania"
...
#define MODULE_HTTPS_API_URL "https://www.YourApi.com/api.php"
#define MODULE_HTTPS_PORT 0
#define MODULE_HTTPS_USR ""
#define MODULE_HTTPS_PSW ""
#define MODULE_HTTPS_USE_CA true
#define MODULE_HTTPS_TIME_OUT 3000
...
"*********  Do not commit your private CA certificates. *********\n" \
"-----END CERTIFICATE-----\n"
